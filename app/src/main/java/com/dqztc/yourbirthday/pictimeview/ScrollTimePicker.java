 ...
 * @since 2015/12/14
 */
public class ScrollTimePicker extends DateTimePicker {

    public ScrollTimePicker(Activity activity) {
     ...
     * @see #HOUR_12
     */
    public ScrollTimePicker(Activity activity, @TimeMode int mode) {
