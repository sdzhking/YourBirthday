...
public class WheelView extends View {
    ...
    public final void setItemsType(List<?> items, String type) {
        this.items.clear();
        for (Object item : items) {
            if (item instanceof WheelItem) {
                this.items.add((WheelItem) item);
            } else if (item instanceof CharSequence || item instanceof Number) {
                this.items.add(new StringItem(item.toString() + type) );
            } else {
                throw new IllegalArgumentException("please implements " + WheelItem.class.getName());
            }
        }
    ...
    public final void setItems(List<?> items, int index, String type) {
        setItemsType(items, type);
        setSelectedIndex(index);
    }
    ...
    public void setTextPadding(int textPadding) {
        this.textPadding = BaseUtil.dip2px(getContext(), textPadding);
    }
    ...
    private void remeasure() {
        ...
        if (useWeight) {
            ...
            if (textPadding < 0) {
                textPadding = BaseUtil.dip2px(getContext(), ITEM_PADDING);
            }
    ...
    private void measuredCenterContentStart(String content) {
        ...
        switch (gravity) {
            case Gravity.CENTER://显示内容居中
                ...
                break;
            case Gravity.LEFT:
                drawCenterContentStart = BaseUtil.dip2px(getContext(), 8);
                break;
    ...
    private void measuredOutContentStart(String content) {
        ...
        switch (gravity) {
            case Gravity.CENTER:
                ...
                break;
            case Gravity.LEFT:
                drawOutContentStart = BaseUtil.dip2px(getContext(), 8);
                break;
            case Gravity.RIGHT:
