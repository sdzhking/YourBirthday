...
import com.dqztc.yourbirthday.BaseUtil;
...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected CharSequence titleText = "选择日期";
    protected int cancelTextColor = 0xFF888888;
    protected int submitTextColor = 0xFF27C2B6;
    protected int titleTextColor = 0xFF555555;
    protected int cancelpressedTextColor = 0xFF888888;
    protected int pressedTextColor = 0xFF27C2B6;
    ...
    protected final View makeContentView() {
        ...
        if (contentLeftAndRightPadding > 0) {
            lr = BaseUtil.dip2px(activity, contentLeftAndRightPadding);
        }
        if (contentTopAndBottomPadding > 0) {
            tb = BaseUtil.dip2px(activity, contentTopAndBottomPadding);
        }
    ...
    protected View makeHeaderView() {
        ...
        int height = BaseUtil.dip2px(activity, topHeight);
        ...
        int padding = BaseUtil.dip2px(activity, topPadding);
        cancelButton.setPadding(padding, 0, padding, 0);
        if (!TextUtils.isEmpty(cancelText)) {
            cancelButton.setText(cancelText);
        }
        cancelButton.setTextColor(BaseUtil.toColorStateList(cancelTextColor, cancelpressedTextColor));
        if (cancelTextSize != 0) {
        ...
        if (null == titleView) {
            ...
            int margin = BaseUtil.dip2px(activity, topPadding);
        ...
        submitButton.setTextColor(BaseUtil.toColorStateList(submitTextColor, pressedTextColor));
        if (submitTextSize != 0) {
